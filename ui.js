...
export let dashImage = 'dash.png';
export let flipTurnImage = 'flipturn.png';
export let rollImage = 'roll.png';
export let bulletImage = 'bullet.png'
export let laserImage = 'laser.png'
export let biteImage = 'bite.png'
